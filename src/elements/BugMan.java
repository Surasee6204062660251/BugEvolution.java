...
public class BugMan extends Element implements Serializable, Runnable {
    ...
    public BugMan() {
        super(new String[]{"bugman_right.png", "bugman_right2.png", "bugman_down.png", "bugman_down2.png",
            "bugman_left.png", "bugman_left2.png", "bugman_up.png", "bugman_up2.png"}, 0, 1);
        this.isVisible = true;
